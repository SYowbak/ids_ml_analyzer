...
NATURE_DEFINITIONS: dict[str, NatureDefinition] = {
    NATURE_NETWORK_INTRUSION: NatureDefinition(
        ...
        supported_models=("Random Forest", "XGBoost", "LightGBM", "MLP", "Autoencoder", "Isolation Forest"),
    ),
    NATURE_CLASSIC_IDS: NatureDefinition(
        ...
        supported_models=("Random Forest", "XGBoost", "SVM", "Decision Tree"),
    ),
    NATURE_MODERN_NETWORK: NatureDefinition(
        ...
        supported_models=("Random Forest", "XGBoost", "LightGBM", "Neural Network"),
    ),
}
